...
<head>
    ...
    <title>DTA6 Unblocked - GNHUSTGames</title>
    <meta name="description" content="The DTA 6 Unblocked game is a fun gangster simulator inspired by the famous GTA series! Even though this game has simpler graphics and functionality, unlike the original, its gameplay can still captivate players for a long time. You will have complete freedom of action to become anything from an inveterate gangster to a good citizen who will not hurt a fly.">
    <meta property="og:image" content="https://github.com/DevrdxDev/Devrdxdev.github.io/blob/main/Main/dta6.png">
    <link rel="icon" href="https://github.com/DevrdxDev/Devrdxdev.github.io/blob/main/Main/dta6.png">
    <link rel="stylesheet" href="TemplateData/style.css" />
    <link rel="stylesheet" href="https://github.com/DevrdxDev/Devrdxdev.github.io/blob/main/Main/logo.css">
...
<body class="light">
    <div class="logo-homepage" id="logo" style="position: absolute; bottom:40%">
        <a href="https://gnhustgames.github.io/homepage/"><button>
            <p>GNHUST Games</p>
            <img src="https://github.com/DevrdxDev/Devrdxdev.github.io/blob/main/Main/logo.jpg" alt="">
        </button></a>
    </div>
    <script>
